...
namespace Dfe.Spi.UkrlpAdapter.Infrastructure.InProcMapping.UnitTests.PocoMapping
{
    public class WhenMappingProviderToLearningProvider
    {
        ...
        [Test, AutoData]
        public async Task ThenItShouldMapProviderToLearningProvider(Provider source, AddressStructure address, long urn, string dfeNumber, string charityNumber, string companyNumber)
        {
